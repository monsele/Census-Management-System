...
namespace CensusManagement_System.Controllers
{
    ...
    public class AdministratorController : Controller
    {
        ...
        private readonly IState stateOfAffairs;
        public AdministratorController(RoleManager<IdentityRole> roleManager, 
            UserManager<User> userManager, IState stateOfAffairs)
        {
        ...
        {
            var census = new AdminViewModel();
            census.CensusCount = userManager.Users.Count();
            //census.CountState=userManager.Users.Where(x=>x.State==)
            census.ThoseInTheCountry = userManager.Users.Where(x => x.IsInCountry == true).Count();
            census.ThoseNotInCountry = userManager.Users.Where(x => x.IsInCountry == false).Count();
            census.NumberOfStates = stateOfAffairs.GetStates().Count();
            return View(census);
        }
